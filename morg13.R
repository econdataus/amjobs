...
#readline("Press enter to continue, escape to exit")
print("CREATE FINAL FILES morg13.txt and morg13.csv") # CHANGE FOR YEARS
write.table(cc, "morg13.txt") # CHANGE FOR YEARS
write.table(cc, "morg13.csv", sep=',') # CHANGE FOR YEARS
